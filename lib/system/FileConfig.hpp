...
namespace libsystem
{
    ...
    public:
        /**
         * Implements the Singletonf pattern
         * returns the unique FileConfig Instance
         */
        ...
        /**
         * @brief Disallow copying of FileConfig
         */
        FileConfig(const FileConfig &) = delete;

        /**
         * @brief disallow the copy assignement operator
         */
         ...
         */
        void load(const storage::Path &path);
        ...
        /**
         * @brief test if key exist or not
         *
         * @param key
